...
# How to install the module as an editable module

To install the module in editable mode in your machine, use the following pip command:
pip install -e "path\to\module\in\your\local\computer\staticCreepPostProcess"

Or, download the **staticCreepModule_renr3.py** file and put in the same folder of your code
